...
router.get('/', (req, res, next) => {
    res.sendFile(process.cwd() + '/views/tingames/Home/Jogos.html');
});

router.get('/jogo-da-velha', (req, res, next) => {
    res.sendFile(process.cwd() + '/views/tingames/Jogos/JogoDaVelha/JogoDaVelha.html');
});

//#region ABCash
router.get('/abcash/questionario', (req, res, next) => {
    res.sendFile(process.cwd() + '/views/tingames/Jogos/ABCash/ABCash-Questionario.html');
});
...
router.get('/abcash/questionario/entradas/', (req, res, next) => {
    ...
    db.query(sql, (err, result) => {
        if (err) throw err;
        res.render(process.cwd() + '/views/tingames/Jogos/ABCash/abcashBanco.ejs', {tabela:"entradas",banco: result});
    })
});
...
router.get('/abcash/questionario/usuarios', (req, res, next) => {
    ...
    db.query(sql, (err, result) => {
        if (err) throw err;
        res.render(process.cwd() + '/views/tingames/Jogos/ABCash/abcashBanco.ejs', {tabela:"usuarios",banco: result});
    })
});
...
router.get('/abcash/questionario/questoes', (req, res, next) => {
    ...
    db.query(sql, (err, result) => {
        if (err) throw err;
        res.render(process.cwd() + '/views/tingames/Jogos/ABCash/abcashBanco.ejs', {tabela:"questoes",banco: result});
    })
});
...
router.get('/abcash/questionario/respostas', (req, res, next) => {
    ...
    db.query(sql, (err, result) => {
        if (err) throw err;
        res.render(process.cwd() + '/views/tingames/Jogos/ABCash/abcashBanco.ejs', {tabela:"respostas",banco: result});
    })
});
