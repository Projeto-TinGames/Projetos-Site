    ...
    for (var l = 0; l < tabuleiro.linhas; l++) {
        for (var c = 0; c < tabuleiro.colunas; c++) {
            if (tabuleiro.casas[l][c].valor != undefined) {
                ...
                imgJogador.src = "/Client/TinGames/Jogos/Jogo-da-Velha/img/Jogadores/" + tabuleiro.casas[l][c].valor + ".png";
...
DesenhaLista = (sala) => {
    if (listaJogadores) {
        ...
        for (i in sala.jogadores) {
            ...
            ctx.stroke();
            var imgJogador = new Image();
            imgJogador.src = "/Client/TinGames/Jogos/Jogo-da-Velha/img/Jogadores/" + sala.jogadores[i].valor + ".png";
